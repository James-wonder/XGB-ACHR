...
![Python](https://img.shields.io/badge/Python-3.8%2B-blue)![XGBoost](https://img.shields.io/badge/Model-XGBoost-orange)![Topic](https://img.shields.io/badge/Topic-Audiology-green)![Status](https://img.shields.io/badge/Data-Private-red)
...
- **Matplotlib / Seaborn**: Result visualization
  ...
  *Note: The script automatically handles mapping F/M to 0/1 and Y/N to 1/0.*
  ...
  | --------------------- | ------------------------------ | ----------------------------------------------------- |
  | Operation             | Surgery Type                   | 1: Tympanoplasty<br>2: Modified Radical Mastoidectomy |
  ...
  **Key Processes:**
  ...
  1. 
  2. **Data Preprocessing**: Missing value imputation and normalization.
  3. **Feature Engineering**: Extraction of key audiological indicators (e.g., Air-Bone Gap).
  4. **Hyperparameter Tuning**: Based on GridSearch or Bayesian Optimization.
  5. **Validation**: 5-Fold Cross Validation to assess model stability.
